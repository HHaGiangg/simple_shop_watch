            ...
            <div class="box-header with-border">
                <div class="box-body">
                    <form role="form" action="" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-sm-8">
                            <div class="from-group {{ $errors->first('sd_title') ? 'has-error':''  }} " >
                        ...
                        <div class="col-sm-8">
                            <div class="from-group {{ $errors->first('sd_link') ? 'has-error':''  }} " >
                                <label for="name">Link <span class="text-danger">(*)</span></label>
                                <input type="text" class="form-control" name="sd_link" value="{{ $slide->sd_link }}" placeholder="Name...">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="from-group" >
                                        ...
                                        <select class="form-control" name="sd_target"  placeholder="Name...">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="box-body block-images">
                                <div style="margin-bottom: 10px"><img src="{{ pare_url_file($slide -> sd_image ?? '')  }}" onerror="this.onerror=null;" alt=" " class="img-thumbnail" style="width: 100%;height: 400px;" ></div>
                ...
                ;opacity:0; background-color:transparent;color: transparent;" name="sd_image" size="40" class="js-upload"></a>&nbsp;<span class="label label-info" id="upload-file-info"></span>
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
                        <div class="col-sm-12">
                            <div class="box-footer text-center">
                                <a href="{{ route('admin.slide.index') }}" class="btn btn-danger">Quay lại <i class="fa fa-undo"></i> </a>
