...
class AdminRequestAttribute extends FormRequest
{
    ...
    {
        return [
            'atb_name.required'          => 'Dữ liệu không không được để trống',
            'atb_name.unique'            => 'Dữ liệu đã tồn tại',
            'atb_type.required'          => 'Dữ liệu không không được để trống',
            'atb_category_id.required'   => 'Dữ liệu không không được để trống'
        ];
    }
}
